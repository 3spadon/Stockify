...
function inscrireUtilisateur($firstName,$lastName,$country,$zip,$email,$username,$password,$newsletter){
  ...
  $sql= "INSERT INTO `utilisateurs` (`id`, `username`, `password`, `email`, `firstName`, `lastName`, `country`, `zip`, `newsletter`, `dateInscription`, `dateDerniereConnexion`, `dateCurrentConnexion`) VALUES (NULL, '".$username."', SHA1('".$password."'), '".$email."', '".$firstName."', '".$lastName."', '".$country."', '".$zip."', '".$newsletter."', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);";
